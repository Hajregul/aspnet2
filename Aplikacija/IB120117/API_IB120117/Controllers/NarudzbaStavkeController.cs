...
namespace API_IB120117.Controllers
{
    public class NarudzbaStavkeController : ApiController
    {
        ...
        public esp_PodaciOKlijentuNarudzbeStavkeByNarudzba_Result KlijentNarudzba(int naruzbaID)
        {
            return db.esp_PodaciOKlijentuNarudzbeStavkeByNarudzba(naruzbaID).FirstOrDefault();
        }
