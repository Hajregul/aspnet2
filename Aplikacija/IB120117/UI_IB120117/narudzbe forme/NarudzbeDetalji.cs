...
namespace UI_IB120117.narudzbe_forme
{
    public partial class NarudzbeDetalji : Form
    {
        ...
        { 
            var response = await _apiServiceklijent.GetById< esp_PodaciOKlijentuNarudzbeStavkeByNarudzba_Result > (narudzbaID);
         
            if (response!=null)
            {
                esp_PodaciOKlijentuNarudzbeStavkeByNarudzba_Result narudzbe = response;
